...
class MicrosoftAuthController extends Controller
{
    ...
    public function handleMicrosoftCallback(Request $request)
    {
        try {
            ...
            $studentCourses = ["2CA-CM", "2CA-CS", "2CB-CM", "2CB-CS", "2CC-CM", "2CC-CS", "2CD-CM", "2CD-CS", "2CE-CM", "2CE-CS", "2CF-CM", "2CF-CS", "2CMA-CM", "2CR-CM", "2CR-CS", "2XA", "2XB"];
        
            $isStudent = !empty(array_intersect($courses, $studentCourses));
            $isTeacher = !$isStudent && !empty(array_intersect($courses, ['EquipDocentLM', 'PersonalDocentLM']));
            $idRole = $isStudent ? 3 : ($isTeacher ? 4 : 2);
            ...
            if ($isStudent) {
                ...
                if ($userSpec) {
                    $student = Student::updateOrCreate(
                        ['idUser' => $user->idUser], 
                        ['name' => $nombre, 'surname1' => $apellido1, 'surname2' => $apellido2, 'idSpecialization' => $userSpec]
                    );
                    if($student) {
