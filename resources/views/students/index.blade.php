...
<div class="container mx-auto p-4 md:p-8 min-h-screen">
    ...
    <div class="p-6 mb-8">
        <form method="GET" action="{{ route('students.index') }}" class="flex flex-col lg:flex-row items-center gap-4">
    ...
    <div id="gridView" class="{{ request('view') == 'list' ? 'hidden' : '' }} grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
