...
<div class="container mx-auto p-6">
    ...
    <div class="mb-6">
        <form method="GET" action="{{ route('teachers.myStudents') }}" class="flex items-center justify-center gap-4">
            ...
            <input type="text" name="search" placeholder="Buscar por nombre..." class="border rounded-lg text-gray-700 p-2" value="{{ request('search') }}" onchange="this.form.submit()">
    ...
    <div id="gridView" class="{{ request('view') == 'list' ? 'hidden' : '' }} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
            ...
            <div class="flex justify-center mt-2">
                <i class="fas fa-{{ $student->verification_status }} text-3xl"></i>
            </div>

            <div class="mt-4 text-center">
                <a href="{{ route('professor.verifyDetails', $student->idStudent) }}" class="text-white bg-blue-600 hover:bg-blue-700 py-2 px-4 rounded-lg">
                    Verificar
                </a>
            </div>
        </div>
        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                <tr class="border">
                    ...
                    <td class="border p-3 text-center">
                        <a href="{{ route('professor.verifyDetails', $student->idStudent) }}" class="text-blue-600 hover:underline">Verificar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
