...
<div class="container mx-auto p-6">
    ...
    <div class="flex justify-center gap-4 mb-6">
        ...
        <a href="{{ route('admin.edit', $user->idUser) }}" class="bg-yellow-600 text-white px-4 py-2 rounded hover:bg-yellow-700 transition duration-300">Editar</a>
    ...
    <!-- Botón Volver Atrás -->
    <div class="flex justify-center">
        <a href="{{ route('admin.empresas_aceptadas') }}" class="bg-gray-500 text-white px-6 py-3 rounded-md shadow hover:bg-gray-600 transition duration-300">
            Volver Atrás
        </a>
    </div>
</div>
