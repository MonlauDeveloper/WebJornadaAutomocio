            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 flex justify-center gap-2">
                        ...
                        <a href="<?php echo e(route('admin.solicitudes.show', $solicitud->idUser)); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-300">Ver Detalles</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/admin/solicitudes.blade.php ENDPATH**/ ?>