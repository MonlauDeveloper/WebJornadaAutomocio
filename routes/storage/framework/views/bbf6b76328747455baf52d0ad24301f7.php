...
<div class="container mx-auto p-6">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('students.updateProject')); ?>" method="POST" enctype="multipart/form-data" class="mt-8 space-y-6">
            ...
            <!-- Video del Proyecto -->
            <div>
                <label for="videoURL" class="block text-lg font-semibold text-blue-500">Video del Proyecto</label>
                <input type="file" id="videoURL" name="videoURL" class="mt-2 p-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                <?php if($project->videoURL): ?>
                    <p class="mt-2 text-sm text-gray-600">Archivo actual: <?php echo e($project->videoURL); ?></p>
                <?php endif; ?>
            </div>
            ...
            <!-- Enlace de Moodle -->
            <div>
                <label for="moodleURL" class="block text-lg font-semibold text-blue-500">Enlace de Moodle</label>
                <input type="url" id="moodleURL" name="moodleURL" value="<?php echo e($project->moodleURL); ?>" class="mt-2 p-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <!-- Descripción del Proyecto -->
            <div>
                <label for="abstract" class="block text-lg font-semibold text-blue-500">Descripción del Proyecto</label>
                <textarea id="abstract" name="abstract" rows="5" class="mt-2 p-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e($project->abstract); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/students/myProject.blade.php ENDPATH**/ ?>