            ...
            <form action="<?php echo e(route('students.updateProfile')); ?>" method="POST" class="space-y-6 mt-4">
                ...
                <div>
                    ...
                    <div id="education-container" class="space-y-2">
                        <?php
                            $educations = explode(';', old('education', $student->education ?? ''));
                        ?>
                        <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="text" name="education[]" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                                       value="<?php echo e($education); ?>" placeholder="Añadir educación">
                ...
                <div>
                    ...
                    <div id="languages-container" class="space-y-2">
                        <?php
                            $languages = explode(';', old('languages', $student->languages ?? ''));
                        ?>
                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="text" name="languages[]" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                                       value="<?php echo e($language); ?>" placeholder="Añadir idioma">
                                <button type="button" class="ml-2 text-red-500 hover:text-red-700 remove-input">
                                    ✖
                                </button>
                            </div>
                ...
                <div>
                    ...
                    <div id="experience-container" class="space-y-2">
                        <?php
                            $workExperiences = explode(';', old('work_experience', $student->workExperience ?? ''));
                        ?>
                        <?php $__currentLoopData = $workExperiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="text" name="work_experience[]" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                                       value="<?php echo e($experience); ?>" placeholder="Añadir experiencia">
                                <button type="button" class="ml-2 text-red-500 hover:text-red-700 remove-input">
                                    ✖
                                </button>
                            </div>
                ...
                <div>
                    ...
                    <div id="contact-container" class="space-y-2">
                        <?php
                            $contacts = explode(';', old('contact', $student->contact ?? ''));
                        ?>
                        <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="text" name="contact[]" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                                       value="<?php echo e($contact); ?>" placeholder="Añadir contacto">
                                <button type="button" class="ml-2 text-red-500 hover:text-red-700 remove-input">
                                    ✖
                                </button>
                            </div>
...
<script>
    ...
    function addInput(containerId, inputName) {
        ...
        // Define el placeholder en español según el tipo de campo
        let placeholderText = '';
        if (inputName === 'education') {
            placeholderText = 'Añadir educación';
        } else if (inputName === 'languages') {
            placeholderText = 'Añadir idioma';
        } else if (inputName === 'work_experience') {
            placeholderText = 'Añadir experiencia';
        } else if (inputName === 'contact') {
            placeholderText = 'Añadir contacto';
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/students/myProfile.blade.php ENDPATH**/ ?>