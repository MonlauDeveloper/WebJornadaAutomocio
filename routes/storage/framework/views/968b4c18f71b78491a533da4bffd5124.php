...
<div class="container mx-auto p-6">
    ...
    <div class="mt-6 text-center">
        <a href="<?php echo e(route('students.descargar', $student->idStudent)); ?>" class="text-white bg-blue-600 hover:bg-blue-700 py-3 px-6 rounded-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/students/show.blade.php ENDPATH**/ ?>