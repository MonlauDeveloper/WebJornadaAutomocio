        ...
        <div class="relative w-full max-w-7xl px-4 lg:px-12">
            ...
            <header class="flex flex-col md:flex-row justify-between items-center py-4 fixed top-0 left-0 right-0 bg-white z-50 shadow-lg px-4">
                <div class="md:ml-12 flex items-center mb-4 md:mb-0">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('images/logoMonlau.png')); ?>" alt="Logo" class="mx-auto h-8">
                    </a>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('login')): ?>
                    <nav class="md:mr-12 flex items-center justify-center space-x-4 md:space-x-6 text-sm md:text-base">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('register-empresa')); ?>" class="text-gray-700 hover:text-gray-800 transition duration-300 font-medium">Empresas</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </nav>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </header>
            ...
            <main class="text-center px-2" style="padding-top: 15px !important;">
                ...
                <section class="py-8">
                    ...
                    <img src="<?php echo e(asset('images/Mapa_Jornada.png')); ?>" alt="Mapa del evento" class="mx-auto w-full max-w-4xl rounded-lg shadow-lg">
                </section>
            </main>
