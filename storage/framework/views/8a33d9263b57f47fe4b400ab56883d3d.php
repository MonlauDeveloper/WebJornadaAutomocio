...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <?php if($student->photoName): ?>
                <p class="mt-2 text-sm text-gray-600">Archivo actual: <?php echo e($student->photoName); ?></p>
            <?php endif; ?>
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="curso" id="curso" value="<?php echo e(old('curso', $student->curso)); ?>" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/students/edit.blade.php ENDPATH**/ ?>