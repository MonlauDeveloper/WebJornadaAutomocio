...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(asset('storage/csv_uploads/Plantilla_Excel.xlsx')); ?>" download class="bg-green-500 text-white py-3 px-6 rounded-lg hover:bg-green-600 transition">
                Descargar Plantilla
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/projects/upload_csv.blade.php ENDPATH**/ ?>