    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.update', $user->idUser)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 mt-4">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->company->logo_url): ?>
                    <div class="mt-4">
                        ...
                        <div class="w-full h-40 bg-gray-50 border border-gray-100 rounded-xl flex items-center justify-center p-4 overflow-hidden shadow-inner">
                            <img src="<?php echo e(asset('storage/photos/' . $user->company->logo_url)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/jornada-automocion-api/resources/views/admin/edit.blade.php ENDPATH**/ ?>