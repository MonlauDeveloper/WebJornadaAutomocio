        ...
        <div class="mt-8">
            ...
            <form action="<?php echo e(route('students.updateProfile')); ?>" method="POST" class="space-y-6 mt-4">
                ...
                <div>
                    ...
                    <textarea id="introduction" name="introduction" placeholder="Buenos días, soy Juanjo y me apasiona..."
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                ...
                <!-- Experiencia Laboral -->
                <div>
                    <label for="work_experience" class="block text-sm font-medium text-gray-600">Experiencia Laborals</label>
                        ...
                        <?php $__currentLoopData = $student->workExperiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="text" name="work_experience[]" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                                       value="<?php echo e($experience->work_experience); ?>" placeholder="Añadir experiencia (Fecha Inicio - Fecha Fin) (Nombre Empresa) (Función Desarrollada)">
                                <button type="button" class="ml-2 text-red-500 hover:text-red-700 remove-input">
                                    ✖
                                </button>
                            </div>
                ...
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg transition">
                    Guardar Cambios
                </button>
            </form>
        </div>
...
<script>
    ...
    function addInput(containerId, inputName) {
        ...
        let placeholderText = '';
        if (inputName === 'education') placeholderText = 'Añadir educación (Fecha Inicio - Fecha Fin) (Nivel de Estudios) (Nombre Escuela)';
