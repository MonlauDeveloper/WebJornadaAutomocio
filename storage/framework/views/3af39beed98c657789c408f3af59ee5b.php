    ...
    <ul class="mt-6 space-y-4">
        <?php $__currentLoopData = $presentations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presentation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="bg-gray-100 p-4 rounded-lg shadow-md">
                ...
                <p class="text-gray-500 text-sm">Fecha de presentación: <?php echo e(\Carbon\Carbon::parse($presentation->presentationDate)->isoFormat('D [de] MMMM [de] YYYY')); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/presentations/index.blade.php ENDPATH**/ ?>