    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('students.updateProject')); ?>" method="POST" enctype="multipart/form-data" class="mt-8 space-y-6">
            ...
            <div>
                ...
                <input type="url" id="videoURL" name="videoURL" value="<?php echo e($project->videoURL); ?>" class="mt-2 p-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ingresa el enlace de YouTube" onblur="validateVideoURL()">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/students/myProject.blade.php ENDPATH**/ ?>