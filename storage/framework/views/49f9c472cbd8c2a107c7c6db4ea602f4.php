    ...
    <div class="grid gap-8 max-w-6xl mx-auto">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-100 sticky top-6">
                ...
                <form method="POST" action="<?php echo e(route('company-tables.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b border-gray-200 hover:bg-gray-50">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <span class="font-medium"><?php echo e($table->idTable); ?></span>
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            <span class="font-medium"><?php echo e($table->companyName); ?></span>
                                            <span class="text-xs text-gray-400 ml-2">(ID: <?php echo e($table->idCompany); ?>)</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center space-x-4">
                                            <a href="<?php echo e(route('company-tables.edit', $table->idTable)); ?>" class="transform hover:text-blue-500 hover:scale-110 transition-transform" title="Editar">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                </svg>
                                            </a>

                                            <form action="<?php echo e(route('company-tables.destroy', $table->idTable)); ?>" method="POST" onsubmit="return confirm('¿Seguro que quieres liberar esta mesa?');">
                                                <?php echo csrf_field(); ?>
