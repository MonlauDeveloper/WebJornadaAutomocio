...
<?php endif; ?>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','id' => 'password_confirmation','name' => 'password_confirmation','class' => 'w-full px-4 py-2.5 border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all text-sm','placeholder' => 'Repite tu contraseña','required' => true,'autocomplete' => 'new-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                ...
                <div class="px-2">
                    <label for="terms" class="flex items-center">
                        ...
                        <span class="text-[11px] text-gray-600 ml-2 leading-tight">
                            Acepto los <a href="<?php echo e(route('terms.show')); ?>" target="_blank" class="text-blue-500 hover:underline font-bold">Términos</a> y la <a href="<?php echo e(route('policy.show')); ?>" target="_blank" class="text-blue-500 hover:underline font-bold">Privacidad</a>.
                        </span>
                    </label>
                </div>
...
<?php endif; ?>
                ...
                <div class="space-y-1 pt-1">
                    ...
                    <p class="text-[11px] text-center text-gray-500">
                        <a href="<?php echo e(route('register-empresa')); ?>" class="text-blue-600 font-bold hover:underline italic">Crear cuenta de empresa</a>
                    </p>
                </div>
            </form>
        </div>
...
</html><?php /**PATH /var/www/jornada-automocion-api/resources/views/auth/register.blade.php ENDPATH**/ ?>