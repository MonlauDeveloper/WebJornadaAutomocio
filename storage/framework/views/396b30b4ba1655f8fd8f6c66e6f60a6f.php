    ...
    <form action="<?php echo e(route('presentations.update', $presentation->idPresentation)); ?>" method="POST" class="space-y-6 mt-6">
        ...
        <div>
            ...
            <input type="time" id="presentationDate" name="presentationDate" 
                value="<?php echo e(old('presentationDate', $presentation->presentationDate->format('H:i'))); ?>" 
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                required>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/presentations/edit.blade.php ENDPATH**/ ?>