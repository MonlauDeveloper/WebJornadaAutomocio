<?php $__env->startSection('content'); ?>
    <div class="flex items-center justify-center bg-gray-100 py-12 px-6">
        <div class="max-w-md w-full bg-white shadow-md rounded-lg p-8">
            ...
            <?php elseif(auth()->user()->status === 'denied'): ?>
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e(route('dashboard')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">Contacto</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/verStatus.blade.php ENDPATH**/ ?>