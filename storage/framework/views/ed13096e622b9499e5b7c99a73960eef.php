...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg text-center">
        ...
        <p class="text-gray-600 mt-4 text-lg"><strong>Ubicación: </strong><?php echo e($project->ubication ? $project->ubication->ubicationName : ''); ?>,<strong> Tribunal: </strong><?php echo e($project->numTribunal); ?></p>
        ...
        <div class="w-3/4 mt-6 mx-auto">
            ...
            <?php if($project->videoURL): ?>
                ...
                <iframe width="100%" height="516" src="<?php echo e($project->videoURL); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/projects/show.blade.php ENDPATH**/ ?>