...
<div class="container mx-auto p-6">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.storeCompany')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6 mt-4">
            <?php echo csrf_field(); ?>

            <!-- Nombre de la Empresa -->
            <div>
                <label for="companyName" class="block text-sm font-medium text-gray-600">Nombre de la Empresa</label>
                <input type="text" name="companyName" id="companyName" value="<?php echo e(old('companyName')); ?>"
            ...
            <div>
                ...
                <input type="url" name="companyWeb" id="companyWeb" value="<?php echo e(old('companyWeb')); ?>"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="asistenteNombre" id="asistenteNombre" value="<?php echo e(old('asistenteNombre')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                </div>
                <div>
                    <label for="asistenteApellidos" class="block text-sm font-medium text-gray-600">Apellidos</label>
                    <input type="text" name="asistenteApellidos" id="asistenteApellidos" value="<?php echo e(old('asistenteApellidos')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="telefonoAsistente" id="telefonoAsistente" value="<?php echo e(old('telefonoAsistente')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                </div>
                <div>
                    <label for="emailAsistente" class="block text-sm font-medium text-gray-600">Email</label>
                    <input type="email" name="emailAsistente" id="emailAsistente" value="<?php echo e(old('emailAsistente')); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="cargoAsistente" id="cargoAsistente" value="<?php echo e(old('cargoAsistente')); ?>"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/admin/create.blade.php ENDPATH**/ ?>