...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-6">
                    ...
                    <p id="limit-message" class="text-xs text-gray-500 mt-2 font-semibold">
                        Seleccionados: <span id="count-display"><?php echo e($project->projectTypes ? $project->projectTypes->count() : 0); ?></span>/3
                    </p>
                ...
                <div class="mb-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->photoName): ?>
                        <div class="mt-3 flex items-center gap-4 p-2 border rounded-lg bg-gray-50 overflow-hidden">
                            ...
                            ?>
                            <img src="<?php echo e($photoUrl); ?>" alt="Foto actual" class="h-12 w-12 sm:h-16 sm:w-16 object-contain bg-white rounded border flex-shrink-0">
                            <div class="flex flex-col min-w-0">
                                <span class="text-[10px] font-bold text-blue-600 uppercase">Archivo actual:</span>
                                <span class="text-[10px] text-gray-500 truncate"><?php echo e(basename($project->photoName)); ?></span>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $project->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative bg-white p-2 rounded border border-gray-200 shadow-sm flex flex-col min-w-0">
                                        <div class="rounded overflow-hidden aspect-video bg-gray-100 mb-2">
                                            <img src="<?php echo e(asset('storage/project_steps/' . $img->file_path)); ?>" class="w-full h-full object-cover">
                                        </div>
                                        ...
                                        <span class="block text-[7px] font-bold text-center py-1 rounded border <?php echo e($badgeColor); ?> uppercase mb-2 truncate">
                                            <?php echo e($label); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($img->fase !== 'header'): ?>
                                            <div class="mt-auto">
                                                <textarea name="image_descriptions[<?php echo e($img->id); ?>]" rows="2" maxlength="300"
                                                    class="w-full text-[10px] border-gray-200 rounded p-1 mb-1 focus:ring-1 focus:ring-blue-400"
                                                    placeholder="Descripción..."><?php echo e($img->description); ?></textarea>
                ...
                <div class="mb-4 p-4 border rounded-lg bg-gray-50">
                    ...
                    <textarea name="conclusion" id="conclusion" rows="4"
                        class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200"
                        placeholder="Escribe aquí el resultado final..." maxlength="300"><?php echo e(old('conclusion', $project->conclusion)); ?></textarea>
                </div>
                    ...
                    <div class="p-2 sm:p-8 bg-gray-400 overflow-y-auto flex-grow shadow-inner">
                        ...
                        <div id="pdf-paper" class="bg-white mx-auto p-6 sm:p-12 text-gray-900 relative shadow-2xl"
                                ...
                                <div class="w-full sm:w-1/3 flex justify-center sm:justify-end">
                                    ...
                                    <div class="border-4 border-white shadow-lg transform sm:rotate-2 overflow-hidden w-40 h-28 bg-gray-100 flex-shrink-0">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portada): ?>
                                            <img src="<?php echo e(asset('storage/project_steps/' . $portada->file_path)); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                            ...
                            <div class="mb-8 border border-gray-100 p-4 rounded bg-blue-50 bg-opacity-30 relative z-10">
                                ...
                                <p id="modal-preview-abstract" class="text-sm text-justify leading-relaxed break-words italic"><?php echo e($project->abstract); ?></p>
                            </div>
                            ...
                            <div id="modal-preview-steps" class="space-y-8 relative z-10">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pasos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex flex-col sm:flex-row gap-6 items-center <?php echo e($index % 2 != 0 ? 'sm:flex-row-reverse' : ''); ?>">
                                        <div class="w-full sm:w-2/5 border p-1 rounded bg-white shadow-sm">
                                            ...
                                            <img src="<?php echo e(asset('storage/project_steps/' . $img->file_path)); ?>" class="w-full h-32 sm:h-36 object-contain bg-gray-50">
                                        </div>
                                        <div class="w-full sm:w-3/5">
                                            <p class="text-xs text-gray-600 text-justify italic step-desc-preview" data-id="<?php echo e($img->id); ?>">
                                ...
                                <div class="mt-12 pt-8 border-t-2 border-dashed border-gray-100 relative z-10">
                                    <div class="flex flex-col sm:flex-row items-center gap-6">
                                        <div class="w-full sm:w-3/4">
                                            ...
                                            <p class="text-xs text-gray-500 italic step-desc-preview" data-id="<?php echo e($final->id); ?>">
                                    ...
                                    <p id="modal-preview-conclusion" class="text-xs text-gray-500 italic break-words">
                                        <?php echo e($project->conclusion ?? 'El proyecto se ha completado satisfactoriamente.'); ?>
