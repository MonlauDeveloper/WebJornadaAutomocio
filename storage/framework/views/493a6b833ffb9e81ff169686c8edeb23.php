    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('students.updateProject')); ?>" method="POST" enctype="multipart/form-data" class="mt-8 space-y-6">
            ...
            <div>
                ...
                <textarea id="abstract" name="abstract" rows="5" maxlength="1500" class="mt-2 p-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e($project->abstract); ?></textarea>
            </div>
