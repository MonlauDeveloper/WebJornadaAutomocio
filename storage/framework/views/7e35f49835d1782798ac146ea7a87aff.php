...
<div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->moodleURL): ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <ul>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $student->workExperiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workExperience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="mt-6 text-center">
        <form action="<?php echo e(route('professor.verify', $student->idStudent)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($student->verification_status == 'verificado'): ?> 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/jornada-automocion-api/resources/views/teachers/verifyStudent.blade.php ENDPATH**/ ?>