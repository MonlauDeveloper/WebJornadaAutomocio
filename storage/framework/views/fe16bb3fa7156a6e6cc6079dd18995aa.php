...
<div class="container mx-auto p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="items-center justify-center mt-6">
            <?php echo e($projects->appends(['specialization' => request('specialization')])->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/JornadasAutomocio2025/resources/views/projects/index.blade.php ENDPATH**/ ?>