...
<?php endif; ?>
                ...
                <p class="text-sm text-center text-gray-600">
                    <a href="<?php echo e(route('register-empresa')); ?>" class="text-blue-500 hover:underline">Crear cuenta de empresa</a>
                </p>
            </form>
        </div>
    </div>
...
<?php /**PATH /var/www/vhosts/alumnes-monlau.com/jornadaautomocion.alumnes-monlau.com/resources/views/auth/register.blade.php ENDPATH**/ ?>