<?php $__env->startSection('content'); ?>
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p class="text-gray-600 mt-4 text-lg max-w-3xl mx-auto leading-relaxed"><?php echo e($project->abstract); ?></p>
            ...
            <div class="w-3/4 mt-6 mx-auto">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->videoURL): ?>
                    ...
                    <iframe width="80%" height="480" style="margin-left: 10%" src="<?php echo e($project->videoURL); ?>" frameborder="0"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->idRole === 1 || auth()->user()->idRole === 4): ?>
                <div class="mt-6">
