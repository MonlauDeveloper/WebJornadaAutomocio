    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('presentations.addSpeaker', $presentation->idPresentation)); ?>" method="POST">
            ...
            <div class="mt-4">
                ...
                <label for="birthDate" class="block text-sm text-gray-600 mt-4">Fecha de Nacimiento</label>
                <input type="date" name="birthDate" id="birthDate" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" required>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/presentations/speaker.blade.php ENDPATH**/ ?>