...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'email','class' => 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none','type' => 'email','name' => 'email','value' => old('email'),'placeholder' => 'Introduce tu email','required' => true,'autofocus' => true,'autocomplete' => 'username']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','class' => 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'placeholder' => 'Introduce tu email','required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
...
<?php endif; ?>
                ...
                <p class="text-sm text-center text-gray-600">
                    <a href="<?php echo e(route('microsoft.login')); ?>" class="text-blue-500 hover:underline">Iniciar sesión con Microsoft</a>
                </p>
...
<?php /**PATH H:\practicas FCT monlau\web1\web1Prueba\web1Prueba\resources\views/auth/login.blade.php ENDPATH**/ ?>